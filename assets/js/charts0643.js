...
NioApp = (function (NioApp, $, window) {
  ...
  NioApp.Chart.ChartJs = function () {
    NioApp.Chart.ChartJs.Doughnut = function (
      _canvas,
      _titles,
      _colors,
      _amounts,
    ...
    NioApp.Chart.ChartJs.Doughnut2 = function (
      _canvas,
      _titles,
      _colors,
      _amounts,
            ...
            hover: {
              onHover: function (e, i) {
                if (i.length) {
                  ...
                  $('[data-canvas="' + _self_can + '"] li').removeClass(
                    "active"
                  );
                  $(
                    '[data-canvas="' +
    ...
    // @since v1.6
    NioApp.Chart.ChartJs.Pie = function (
      _canvas,
      _label,
      _title,
      _colors,
      ...
      $chart.each(function () {
        var $chart_data = $(this).children("li"),
          ...
          _canvas_border = $(this).data("border-color")
            ...
            : "#fff",
          _canvas_cutout = $(this).data("canvas-cutout")
            ? $(this).data("canvas-cutout")
            : "70",
        ...
        if (typeof _canvas !== "undefined" && _canvas !== "") {
          ...
          $chart_data.each(function () {
            ...
            item_percent.push(p);
            $(this).html(
              '<span class="chart-c" style="background-color: ' +
                c +
                '"></span><span class="chart-l">' +
                l +
                '</span><span class="chart-p">' +
                p +
                "%</span>"
            );
          });
          if (_canvas_type === "doughnut") {
            NioApp.Chart.ChartJs.Doughnut(
              _canvas,
              item_label,
              item_color,
              item_percent,
        ...
        if (typeof _canvas !== "undefined" && _canvas !== "") {
          ...
          $chart_data.each(function () {
            ...
            $(this).html(
              '<span class="chart-l">' +
                l +
                '</span><span class="chart-p" style="background-color: ' +
                c +
                '" ><span>' +
                p +
                "%</span></span>"
          ...
          if (_canvas_type === "doughnut") {
            NioApp.Chart.ChartJs.Doughnut2(
              _canvas,
              item_label,
              item_color,
              item_percent,
